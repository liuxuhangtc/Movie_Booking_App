...
extension MTBaseViewController {
    ...
    func addNavigationBarLeftButton2(_ taget: Any, action: Selector = #selector(popBack), image: UIImage? = AppConfig.backImage) -> UIButton {
        ...
        leftButton.transform = CGAffineTransform(translationX: -15, y: 0)   //
    ...
    @discardableResult
    func addNavigationBarRightButton(_ taget: Any, action: Selector, text: String, color: UIColor? = MTColor.title222) -> UIButton {
